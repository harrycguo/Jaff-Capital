...
public class JaccardSimilarity {
    ...
    public Double Calc(HashSet<Integer> hs1, HashSet<Integer> hs2) {
...
//        System.out.println(union.size());
    ...
    public Double CalcJaccardSimilarity(List<Integer> ls1, List<Integer> ls2)
    {
        HashSet<Integer> hs1 = new HashSet<Integer>(ls1);
        HashSet<Integer> hs2 = new HashSet<Integer>(ls2);
        return Calc(hs1, hs2);
    }
